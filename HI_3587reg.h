...
#ifndef HI_3587REG_H_
#define HI_3587REG_H_
...
/*! HI_358 registers list*/
enum HI_3587_registers
{
    RESERVED0 = 0x00,
    MASTER_RESET,
    RESERVED1,
...
st_reg HI_3587_regs[] =  //HI_358772-2 INIT
{

 // 레지스테 파리미터 설정은 24 bit로 설정해야 됨.
 ////////////중요/////////////////////////////////////////////////
    {0x00, 0x00000000, 6}, // IDs-16, ch0-24, ch1-24, crc-16 =
    {0x01, 0x00000000, 6}, // STATUS
    {0x02, 0x00000000, 6}, // MODE
    {0x03, 0x00000000, 6}, // CLOCK , ch0 enable
    {0x04, 0x00000000, 6}, // gain ch0 - 128   0000 0000 0000 0000 0111 0111 xxxx xxxx
    {0x05, 0x0000, 2}, // CFG
    {0x06, 0x0000, 2}, // THRSHLD_MSB
    {0x07, 0x0000, 2}, // THRSHLD_LSB
    {0x08, 0x0000, 2}, // CH0_CFG
    {0x09, 0x0000, 2}, // CH0_OCAL_MSB
    {0x0A, 0x0000, 2}, // CH0_OCAL_LSB
    {0x0B, 0x0000, 2}, // CH0_GCAL_MSB
    {0x0C, 0x0000, 2}, // CH0_GCAL_LSB
    {0x0D, 0x0000, 2}, // CH1_CFG
    {0x0E, 0x0000, 2}, // CH1_OCAL_MSB
    {0x0F, 0x0000, 2}, // CH1_OCAL_LSB
    {0x10, 0x0000, 2}, // CH1_GCAL_MSB
    {0x11, 0x0000, 2}, // CH1_GCAL_LSB
    {0x12, 0x0000, 2}, // REGMAP_CRC
    {0xFF, 0x0000, 2}  // ADIS16467_REG_NO
 //-------------------------------------------------------------------------------

};

//extern st_reg HI_3587_regs[];
...
#define CHANNEL_COUNT (2)   // HI_3587M04 -> 4 Channels

#if ((CHANNEL_COUNT < 1) || (CHANNEL_COUNT > 8))
    #error Invalid channel count configured in 'HI_3587m0x.h'.
#endif
 ...
 *  NOTE 2: Bits 0 through 4 are RESERVED on the HI_3587M04. These bits will always read 0.
 */
 ...
 * -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 *  NOTE 1: Bits 12 through 15 are RESERVED on the HI_3587M04.
 */
 ...
 * -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 * NOTE 1: This register is RESERVED on the HI_3587M04. Only write 0x0000 to this register.
 */
